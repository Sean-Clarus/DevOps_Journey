...
# Relational Database Service (RDS) # Session starts at 6pm# launched 2 instances of Amazon Linux 2 and name them as MySQL DB Server, and MariaDB Server
# configure security group to allow SSH connection (Port 22) and sql connection (Port 3306)# Part-1
